            ...
            <div class="block block-rounded block-bordered">
                ...
                <form action="{{route('actualizar_periodo', ['id' => $periodo->id])}}" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>Región</label>
                            <input type="text" name="region" class="form-control bg-white " value="{{$periodo->region}}">
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Estado</label>
                            <input type="text" name="estado" class="form-control bg-white " value="{{$periodo->estado}}">
                        </div>
                    </div>
