                ...
                <div class="block-content ">
                    <form action="{{route('postulacion.update', ['postulacion'=>$postulacion->id])}}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group ">
                                <label>Estado</label>
                                <select class="form-select" name="estado_postulacion">
                                    <option value="{{$postulacion->estado_postulacion_id}}" selected  hidden>{{$postulacion->estado_postulacion->nombre_estado_postulacion}}</option>
                                    @foreach ($estado_postulacion as $estado)
                                        <option value="{{$estado->id}}">{{$estado->nombre_estado_postulacion}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
